...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      id: 'o5_pB5yVGQBZoZPbnYBzRJkIs9QE',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'Rk0LIR6wCPkdqb_OBTxKPOS2Y-nTs2can8PbSEuOpdw',
      // 所在省份
      province: '吉林',
      // 所在城市
      city: '长春',
      ...
      openUrl: 'https://momoyu.cc/',
      // 专属节日提醒，如果你在这里填写了节日提醒，就不会执行FESTIVALS的提醒了, 和FESTIVALS的配置方法相同，可以往下查看，我这里就不重复写了
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
          type: '*生日', name: 'mama', year: '1972', date: '03-04',
        },
  ...
  CALLBACK_TEMPLATE_ID: 'Ke5VemAPSmh76MUY0WqLuiA0hZA8wevDlC1Xl2UGVeU',
